...
for file in *.md; do
  clean_name=Backend and API Apr122025 181611
  timestamp=Apr122025_181611
  new_name="Home_Apr122025_181611.md"
  mv "Backend_and_API_Apr122025_181611.md" "Home_Apr122025_181611.md"
done
...
for file in *.md; do
  if [[ "Backend_and_API_Apr122025_181611.md" != "Home.md" ]]; then
    title=Backend and API Apr 
    cat <<EOL > "Backend_and_API_Apr122025_181611.md"
# Backend and API Apr 
